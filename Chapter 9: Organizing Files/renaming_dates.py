#! python3
# renaming_dates.py - Renames filenames with American MM-DD-YYYY date format
...
for amer_filename in os.listdir('.'):
    ...
    euro_filename = '%s%s-%s-%s%s' % (before_part, day_part, month_part, year_part, after_part)
    ...
    # Rename the files
    print('Renaming to "%s"...' % euro_filename)
